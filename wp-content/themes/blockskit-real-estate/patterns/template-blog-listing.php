 ...
 * Slug: blockskit-real-estate/template-blog-listing
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"blockskit-real-estate"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->